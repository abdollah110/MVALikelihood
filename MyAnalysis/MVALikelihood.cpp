...
int main(int argc, char * argv[]) {
    ...
    // Wtaunu
    TH1F * PFMET_Sig = new TH1F("PFMET_Sig", "", 25, 0., 1.); // dimuon pt - to scalar sum of muons' pt ratio
    TH1F * RHT_Sig = new TH1F("RHT_Sig", "", 25, -3, 2);
    TH1F * likelihoodSignal = new TH1F("likelihoodSignal", "", 20, 0, 1);

    // BG Mainly Data
    TH1F * PFMET_BG = new TH1F("PFMET_BG", "", 25, 0., 1.); // dimuon pt - to scalar sum of muons' pt ratio
    TH1F * RHT_BG = new TH1F("RHT_BG", "", 25, -3, 2);
    ...
    TFile * fileZTauTau = new TFile("Sig.root");
